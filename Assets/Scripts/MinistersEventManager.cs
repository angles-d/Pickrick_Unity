...
public class MinistersEventManager : MonoBehaviour {
    ...
    public void MinChangeCurrentEvent() {
        //LeanTween.moveLocalX(gameObject, currentEvent.positionWhereCentered , changeMinistersEventAnimationSpeed);
